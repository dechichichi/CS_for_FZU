...
| 资源链接                                                     | 作者         | 分享人       | 描述                                                         |
| ------------------------------------------------------------ | ------------ | ------------ | ------------------------------------------------------------ |
| [个人笔记](https://harveyblocks.github.io)                   | HarveyBlocks | HarveyBlocks | 从Java后端开发的角度构建的笔记, 但不止Java技术栈, 还有其他方面的笔记 |
| [algorithm-stl](https://github.com/HarveyBlocks/algorithm-stl) | HarveyBlocks | HarveyBlocks | 对一些数据结构和算法的简单实现的仓库, C/Cpp实现, 没有做太多针对性的优化 |
|                                                              |              |              |                                                              |
